-- ============================================================
-- הרץ ב-Supabase: SQL Editor → New query → הדבק את כל הקובץ → Run
-- מתאים לפרויקט קיים שחסרות בו עמודות/טבלאות (profiles: diamonds, banned; block_logs)
-- ============================================================
...
-- 4) challenge_templates – יהלומים לפרס + אתגר שבועי (אם הטבלה קיימת)
...
-- 5) לוג חסימות/ביטול חסימה (אדמין)
